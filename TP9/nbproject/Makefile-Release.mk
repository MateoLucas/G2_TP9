...
${OBJECTDIR}/_ext/5d8126cf/input_arreglo.o: ../../../../input_arreglo.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5d8126cf/input_arreglo.o ../../../../input_arreglo.c

${OBJECTDIR}/_ext/5d8126cf/main.o: ../../../../main.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5d8126cf
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5d8126cf/main.o ../../../../main.c

${OBJECTDIR}/_ext/5d8126cf/palin.o: ../../../../palin.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5d8126cf
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5d8126cf/palin.o ../../../../palin.c
