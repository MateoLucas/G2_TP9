...
${OBJECTDIR}/input_arreglo_nomain.o: ${OBJECTDIR}/input_arreglo.o input_arreglo.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/input_arreglo_nomain.o input_arreglo.c;\
	else  \
...
${OBJECTDIR}/palin_nomain.o: ${OBJECTDIR}/palin.o palin.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/palin_nomain.o palin.c;\
	else  \
